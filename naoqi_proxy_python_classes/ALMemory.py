...
class ALMemory(object):
    ...
    def addMapping(self, service, signalEvent):
        """Add a mapping between signal and event
    ...
    def declareEvent(self, eventName, extractorName):
        """Declares an event to allow future subscriptions to the event
    ...
    def getData(self, key, deprecatedParameter):
    ...
    def subscribeToEvent(self, name, callbackModule, callbackMessage, callbacMethod):
